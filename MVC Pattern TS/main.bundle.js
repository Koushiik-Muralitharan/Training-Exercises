...
logoutIcon.onclick = function () {
    UserAccountArray.forEach((user) => {
        if (user.loggedStatus === "in" && user.name === (userAccount === null || userAccount === void 0 ? void 0 : userAccount.name) && user.email === (userAccount === null || userAccount === void 0 ? void 0 : userAccount.email)) {
...
let editGoalID = null;
function editGoalModal(goalID, goalName) {
        ...
        userGoal.forEach((goal) => {
            ...
            if (!(temp <= goal.goalAmount && goal.goalId === currentGoalID)) {
                ...
                if (goal.goalContribution === goal.goalAmount && goal.goalStatus !== "yes") {
                    ...
                    var closePopup = document.getElementById("close-congratulation-popup");
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const closeSidebarMenuBtn = document.getElementById('close-sidebar-menu');
    const goalsSection = document.getElementById('sidebar-1');
...
const MainPage_1 = __webpack_require__(/*! ../MainPage */ "./MainPage.ts");
const MainPage_2 = __webpack_require__(/*! ../MainPage */ "./MainPage.ts");
...
class GoalRepository {
    ...
    calculateSavings() {
        ...
        expenseRepo.calculateTotals();
        MainPage_2.totalSavingsdisplay.innerText = `Savings: ${this.totalSavings}`;
    }
}
...
/******/ 	var __webpack_exports__ = __webpack_require__("./MainPage.ts");
/******/ 	
/******/ })()
;
